...
from apps.discord_bot.commands.base import RemoteControl, _build_help_embed
from apps.discord_bot.ui_labels import SIMPLE_PANEL_BUTTON_LABELS, ADVANCED_PANEL_BUTTON_LABELS
...
async def test_help_command_shows_beginner_guide(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("apps.discord_bot.commands.base._is_admin", lambda _i: False)
...
async def test_help_command_shows_admin_features(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("apps.discord_bot.commands.base._is_admin", lambda _i: True)
