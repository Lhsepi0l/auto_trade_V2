...
class RiskConfigRepo:
    ...
    def upsert(self, cfg: RiskConfig) -> None:
        ...
        values = (
            ...
            float(cfg.tf_weight_10m),
            float(cfg.tf_weight_15m),
            int(bool(cfg.score_tf_15m_enabled)),
        ...
        self._db.execute(
            ...
            ON CONFLICT(id) DO UPDATE SET
                ...
                tf_weight_10m=excluded.tf_weight_10m,
                tf_weight_15m=excluded.tf_weight_15m,
                score_tf_15m_enabled=excluded.score_tf_15m_enabled,
