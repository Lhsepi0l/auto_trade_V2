...
from v2.kernel.defaults import (
...
def _build_strategy_selector(
    *,
    ...
    elif strategy_name == "ebc_v1_continuation":
        from v2.strategies.ebc_v1_continuation import EBCV1Continuation as StrategyImpl
    else:
    ...
    if strategy is None:
        ...
        if strategy_name == "ra_2026_alpha_v2":
            ...
            from v2.strategies.ebc_v1_continuation import (
                EBCV1ContinuationCandidateSelector as SelectorImpl,
            )
        else:
            raise ValueError(f"unsupported_strategy:{strategy_name}")
